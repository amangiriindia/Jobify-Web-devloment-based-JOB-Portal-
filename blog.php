                    ...
                    <?Php
                        ...
                        <article class="blog_item">
                            ...
                            if($image_name=="")
                              ...
                              {
                                  ?>
                                  <img class="card-img rounded-0" src="admin/img/<?php echo $image_name; ?>" alt="">
                              <?php
                              }
                              ?>
                            ...
                            <div class="blog_details">
                                <a class="d-inline-block" href="single-blog.php">
                                    <h2><?php echo $short_dest;?></h2>
                                </a>
                                <p><?php echo $dest;?></p>
                                <ul class="blog-info-link">
                                    <li><a href="#"><i class="fa fa-user"></i> <?php echo $tag;?>, <?php echo $category;?></a></li>
