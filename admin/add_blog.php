...
<div class="main-content">
    ...
    <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item"><a href="add_blog.php">Add Blog</a></li>
            </ol>
          </nav>
  ...
  <form action=""method="POST" enctype="multipart/form-data">
            <table class='tbl-30'>
                ...
                <tr>
                    <td>Blog Tag:</td>
                    <td>
                        <input type="text"name="tag"placeholder="Blog tag">
                    </td>
                </tr>
                <tr>
                    <td>Blog Image:</td>
                ...
                <tr>
                    <td>Spacial Blog:</td>
                    <td>
                        <input type="radio"name="recent" value="Yes">Yes
                        <input type="radio"name="recent" value="No">No
                    </td>
                </tr>
                <tr>
                    <td>Short Description:</td>
                    <td>
                        <textarea name="short_dest"  cols="30" rows="3" placeholder="Description "></textarea>
                    </td>
                </tr>
                <tr>
                    <td>Description:</td>
                    <td>
                        <textarea name="dest"  cols="30" rows="5" placeholder="Description "></textarea>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
     ...
     else
     {
        ...
        if(isset($_FILES['image']['name']))
        {
            ...
            if($image_name!="")
            {
                ...
                //Rename the image
                $image_name = "blog".rand(000,999).'.'.$ext;//e.g.Food-name-345.jpg
